# v0.3.0-beta.4 ship-readiness review

Reviewed: 2026-07-28

Outcome: **shippable as a beta prerelease**. No open P0 or P1 issue remains
...
| Lovely/mod packaging | 19 live Lovely signatures, 3 GameManager hooks, 29 in-game commands, and both `0.3.0-beta.4` ZIPs passed |
...
| Runtime lifecycle    | Ready on protocol 3; 26.6 MiB idle working set; mutex, explicit shutdown, and parent-exit cleanup passed |
...
- chart cache hit: 21.90 ms versus 162.53 ms cold, a 7.42× speedup;
- completed export publication p95: 2.61 ms;
- buffered journal throughput: about 1.06 million events/s;
- SQLite journal throughput: about 325k events/s;
